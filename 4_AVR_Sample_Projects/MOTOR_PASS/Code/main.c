...
interrupt [EXT_INT1] void ext_int1_isr(void)
{
    ...
    if (status != S_MOTOR_RUN_MODE)
    {
        status = S_CHANGE_PASSWORD;
    }
}
...
// Function: Bit7=In Bit6=In Bit5=In Bit4=In Bit3=Out Bit2=In Bit1=In Bit0=Out 
DDRA=(0<<DDA7) | (0<<DDA6) | (0<<DDA5) | (0<<DDA4) | (1<<DDA3) | (0<<DDA2) | (0<<DDA1) | (1<<DDA0);
// State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=0 Bit2=T Bit1=T Bit0=0 
...
// State: Bit7=P Bit6=P Bit5=0 Bit4=P Bit3=T Bit2=T Bit1=T Bit0=T 
PORTC=(1<<PORTC7) | (1<<PORTC6) | (0<<PORTC5) | (1<<PORTC4) | (0<<PORTC3) | (0<<PORTC2) | (0<<PORTC1) | (0<<PORTC0);
...
/* Setting up Default Pass at first */
Read_Pass_fromEEP(pass);
if (pass[0] > 9)
{
    Write_Pass_toEEP(pass_md);
}

Read_Pass_fromEEP(pass_md);
Assign_Pass(pass, pass_md);
        ...
        {   
            ...
            {   
                ...
                if( check(pass,mk) )
                {
                    ...
                    status = S_MOTOR_RUN_MODE;
                    j = 0;
                }
                else
                {
                    j++;
                    if(j>=3)    /* Fail pass > 3 times -> Warning */   
                    {
                        lcd_clear();
                        delay_ms(2);
                        ...
                        /* Buzzer ON in 10s to Warning */
                        j=0;                      
                        Buzzer = 1;
                        delay_ms(10000);
                        Buzzer = 0;
                    }
                    else    /* Fail pass < 3 times */
                    {
                        lcd_gotoxy(0,1);
